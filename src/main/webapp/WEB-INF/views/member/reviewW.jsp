...
<div class="fs-4 text-center mx-auto my-5 fw-bolder pb-2 border-bottom" style="clear:both;"> 리뷰 쓰기</div>
<form action="/member/reviewWrite.do" name="reviewFm" id="reviewFm" method="post" 
   ...
   <div class="mb-3" style="line-height:30px;">
   	...
   	<textarea name="rContent" id="rContent" cols="30" rows="10" placeholder="20자 이상 800자 이내로 작성해주세요."
   	 class="form-control form-control-sm" style="padding:10px;" onkeyup="handleTA('ta_count');"></textarea> 
   	 <span class="count"> <span id="ta_count">0 </span> / 800</span><br />
...
<div class="text-center"><button class="btn8" id="reviewBtn" type="submit">리뷰등록</button>&nbsp;&nbsp;&nbsp;
