...
<form name="stateChange">
	...
	<%@ include file="../include/adminSidebar.jsp" %>
                ...
                <div class="container-fluid p-5">
                    <h3 class="mb-3 text-gray-800 fw-bolder">작가신청 관리</h3>
                    <p class="mb-4">
                    	${error }
                    </p>
                    <div>
    ...
    <c:otherwise> 
        <c:forEach items="${ lists }" var="row" varStatus="loop">    
                                        <tr>
                                            ...
                                            <td><a href="/admin/artistApplyView?apply_idx=${ row.apply_idx }">${ row.m_name }</a></td>
...
$( document ).ready( function() {
	...
	$('ul.sidebar li:eq(2)').addClass( 'active' );
	$('ul.sidebar li:eq(2) a').addClass( 'active' );
});
</script>